...
const Button = ({ title, className, link, onClick }: Props) => {
    return (
        ...
        </Link> : <button onClick={onClick} className={`rounded-full hover:scale-95 duration-300 bg-gradient-to-tr group from-blue-400 to-blue-900 bg-blue-700 text-white w-[150px] h-[50px]  font-nunito font-semibold ${className} relative overflow-hidden `} >
